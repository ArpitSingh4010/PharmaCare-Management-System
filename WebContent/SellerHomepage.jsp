<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%><%@ include file="SessionCheck.jsp" %><!DOCTYPE html>
<html>
<head>
...
<div class="main">
	...
	try{
		...
		conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/drugdatabase?useSSL=false&serverTimezone=UTC","root","1234");
